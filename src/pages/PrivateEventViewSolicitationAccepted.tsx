  ...
  return (
    <Frame>
      ...
      <Flex direction="column" alignItems="center" gap={5} mt={5}>
        ...
        <Form
          action="/confirmarPresençaPrivateEvent"
          method="post"
          btnActionLabel="Confirmar Presença"
          children={undefined}
        />

        <Form
          action="/cancelarPresençaPrivateEvent"
          method="post"
          btnActionLabel="Cancelar Presença"
          children={undefined}
          buttonBgColor="red"
        />
      </Flex>
...
export default PrivateEventViewSolicitationAccepted;
